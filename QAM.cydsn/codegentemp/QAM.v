// ======================================================================
// QAM.v generated from TopDesign.cysch
// 11/11/2017 at 00:51
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=X, CY_INSTANCE_SHORT_NAME=X, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=X, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Y, CY_INSTANCE_SHORT_NAME=Y, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Y, )
...
module top ;
    ...
    VDAC8_v1_90_0 X (
        ...
        .data(8'b00000000),
        .vOut(Net_12));
    defparam X.Data_Source = 0;
    defparam X.Initial_Value = 100;
    defparam X.Strobe_Mode = 0;

    VDAC8_v1_90_1 Y (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_13));
    defparam Y.Data_Source = 0;
    defparam Y.Initial_Value = 100;
    defparam Y.Strobe_Mode = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("ddffe26f-d3b4-4862-b51c-2d900f64aa63"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_in_clk_net;
	wire [0:0] tmpFB_0__Pin_in_clk_net;
	wire [0:0] tmpIO_0__Pin_in_clk_net;
	electrical [0:0] tmpSIOVREF__Pin_in_clk_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_in_clk
		 (.oe(tmpOE__Pin_in_clk_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_in_clk_net[0:0]}),
		  .io({tmpIO_0__Pin_in_clk_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_in_clk_net),
		  .interrupt({Net_16}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_in_clk_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_2 CLOCK (
        ...
        .ph1(Net_43),
        .ph2(Net_44));
    defparam CLOCK.Resolution = 8;


	cy_clock_v1_0
		#(.id("0e06f53a-07b1-40c3-a752-321c2c6a96b9"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Pin_out_clk1_net;
	wire [0:0] tmpFB_0__Pin_out_clk1_net;
	wire [0:0] tmpIO_0__Pin_out_clk1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_out_clk1_net;
	electrical [0:0] tmpSIOVREF__Pin_out_clk1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_out_clk1
		 (.oe(tmpOE__Pin_out_clk1_net),
		  .y({Net_49}),
		  .fb({tmpFB_0__Pin_out_clk1_net[0:0]}),
		  .io({tmpIO_0__Pin_out_clk1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_out_clk1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_out_clk1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_out_clk1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_out_clk2_net;
	wire [0:0] tmpFB_0__Pin_out_clk2_net;
	wire [0:0] tmpIO_0__Pin_out_clk2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_out_clk2_net;
	electrical [0:0] tmpSIOVREF__Pin_out_clk2_net;

	cy_psoc3_pins_v1_10
		#(.id("814fd5b9-0880-47f8-821e-b3aef669abc3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_out_clk2
		 (.oe(tmpOE__Pin_out_clk2_net),
		  .y({Net_50}),
		  .fb({tmpFB_0__Pin_out_clk2_net[0:0]}),
		  .io({tmpIO_0__Pin_out_clk2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_out_clk2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_out_clk2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_out_clk2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__data_out_net;
	wire [0:0] tmpFB_0__data_out_net;
	wire [0:0] tmpIO_0__data_out_net;
	wire [0:0] tmpINTERRUPT_0__data_out_net;
	electrical [0:0] tmpSIOVREF__data_out_net;

	cy_psoc3_pins_v1_10
		#(.id("e076f8c1-cf37-42e0-a5c4-72654f1e1559"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__data_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__signX_net;
	wire [0:0] tmpFB_0__signX_net;
	wire [0:0] tmpIO_0__signX_net;
	wire [0:0] tmpINTERRUPT_0__signX_net;
	electrical [0:0] tmpSIOVREF__signX_net;

	cy_psoc3_pins_v1_10
		#(.id("03e16b72-b49b-4081-aca9-0c85a80258e7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		signX
		 (.oe(tmpOE__signX_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__signX_net[0:0]}),
		  .io({tmpIO_0__signX_net[0:0]}),
		  .siovref(tmpSIOVREF__signX_net),
		  .interrupt({tmpINTERRUPT_0__signX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__signX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__signY_net;
	wire [0:0] tmpFB_0__signY_net;
	wire [0:0] tmpIO_0__signY_net;
	wire [0:0] tmpINTERRUPT_0__signY_net;
	electrical [0:0] tmpSIOVREF__signY_net;

	cy_psoc3_pins_v1_10
		#(.id("0c8e57a3-db93-4430-9b0e-2a42cce19614"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		signY
		 (.oe(tmpOE__signY_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__signY_net[0:0]}),
		  .io({tmpIO_0__signY_net[0:0]}),
		  .siovref(tmpSIOVREF__signY_net),
		  .interrupt({tmpINTERRUPT_0__signY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__signY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
